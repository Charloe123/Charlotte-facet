      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
        {rings.map((ring) => (
          <div
            ...
            onClick={() => router.push(`/products/${ring._id}`)}
          >
            <div className="relative w-full h-64 mb-4 overflow-hidden rounded-xl">
              <Image
                src={ring.imageUrl}
                alt={`${ring.title} - ${ring.description?.substring(0, 50) || 'Stylish ring'}...`}
                width={400}
                height={400}
            ...
            <p className="text-[#D4AF37] font-bold text-2xl mt-2 tracking-wider">${ring.price}</p>
