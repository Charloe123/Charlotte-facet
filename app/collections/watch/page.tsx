// app/collections/watch/page.tsx
"use client";
        ...
        {watches.map((watch) => (
          ...
          >
            <div className="relative w-full h-64 mb-4 overflow-hidden rounded-xl">
              <Image
                src={watch.imageUrl}
                alt={`${watch.title} - ${watch.description?.substring(0, 50) || 'Stylish watch'}...`}
                width={400}
                height={400}
            ...
            <p className="text-[#D4AF37] font-bold text-2xl mt-2 tracking-wider">${watch.price}</p>
